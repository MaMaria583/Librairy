      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5 md:col-span-2">
          ...
          <p className="text-sm text-slate-500 mb-3">
            La base de données PostgreSQL est hébergée sur Neon. Les connexions sont configurées via les variables d&apos;environnement <code className="bg-slate-100 px-1.5 py-0.5 rounded text-xs">DATABASE_URL</code> et <code className="bg-slate-100 px-1.5 py-0.5 rounded text-xs">DIRECT_URL</code>.
          </p>

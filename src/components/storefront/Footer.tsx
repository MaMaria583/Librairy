        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 border-b border-slate-800 pb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.tiktok.com/@librairie_darelhi" target="_blank" rel="noopener noreferrer" className="bg-slate-800 p-2 rounded-full hover:bg-black hover:text-white transition-all">
